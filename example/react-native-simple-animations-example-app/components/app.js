...
export class App extends Component {
    ...
    render = () => {
        const { aim, delay, direction, directionPickerActive, distance, duration, friction, movementType, movementTypePickerActive, staticType, staticTypePickerActive } = this.state;
        ...
        const onMovementTypePickerToggle = () => this.setValueToState('movementTypePickerActive', !movementTypePickerActive);
